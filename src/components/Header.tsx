...
import { Bell, ChevronDown, Flame, Gem, LogIn, LogOut, Moon, Sun, UserCheck, UserX, Volume2, VolumeX } from 'lucide-react';
              ...
              >
                ...
                <div className="px-2 py-1.5">
                  <a
                    ...
                    className="flex items-center space-x-2 px-2.5 py-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-[#1a1d1a] text-slate-700 dark:text-slate-300 font-medium transition-colors"
                  >
                ...
                <div className="border-t border-slate-100 dark:border-[#383c38] mt-1 pt-1 px-2">
                  <button
                    ...
                    className="w-full text-left flex items-center space-x-2 px-2.5 py-1.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/40 text-red-600 dark:text-red-400 transition-colors"
                  >
